...
export default function Footer() {
  return (
    <footer className="bg-[#2a1a13] text-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-16 grid md:grid-cols-4 gap-10">
        <Reveal direction="up" duration={700} className="space-y-3">
          <div className="flex items-center gap-2">
            <Image src="/logo-with-text.svg" alt="Woodcraft" width={200} height={50} />
          </div>
        </Reveal>
        ...
        <Reveal direction="scale" duration={700} className="space-y-2 md:justify-self-end md:translate-x-2">
          <div className="font-semibold">Newsletter</div>
          <form className="mt-2 flex gap-3">
            <input
              type="email"
              placeholder="Email"
