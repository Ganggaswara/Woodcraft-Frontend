...
export default function TransactionsToolbar({ query, setQuery, status, setStatus, month, setMonth, year, setYear, years, onExport }: Props) {
  return (
    <div className="grid sm:grid-cols-[1fr_auto_auto_auto_auto] gap-3 items-center">
      ...
      <button onClick={onExport} className="px-4 py-2 rounded-md bg-[#5C3D2E] text-white font-semibold">Export</button>
    </div>
  );
}
